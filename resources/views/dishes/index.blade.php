            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <a href="{{ url('/dishes/create') }}" class="btn btn-success btn-sm" title="Add New Dish">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                @foreach($dishes as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->name }}</td><td>{{ $item->price }}</td><td>{{ $item->weight }}</td>
                                        <td>{{ $item->category()->first()->name }}</td>
                                        <td>
                                            <a href="{{ url('/dishes/' . $item->id) }}" title="View Dish"><button class="btn btn-info btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/dishes/' . $item->id . '/edit') }}" title="Edit Dish"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/dishes', $item->id],
